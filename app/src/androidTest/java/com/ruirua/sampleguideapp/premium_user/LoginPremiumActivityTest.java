...
public class LoginPremiumActivityTest {
    ...
    @Test
    public void loginPremiumActivityTest() {
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.profile_name), withText("premium_user"),
                        withParent(withParent(withId(R.id.profile_scroll))),
                        isDisplayed()));
        textView.check(matches(withText("premium_user")));

        ViewInteraction imageView = onView(
                allOf(withId(R.id.profile_premium), withContentDescription("Premium Logo"),
                        withParent(allOf(withId(R.id.profile_images),
